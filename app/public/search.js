...
function onClickTopResult(){
    if(topType.innerText === "SONG") window.location.href = "/search/" + keyword[0].id + "/artist/" + topResultId[1].id + "/album/" + topResultId[0].id;
    else if(topType.innerText === "ALBUM") window.location.href = "/search/" + keyword[0].id + "/artist/" + topResultId[1].id + "/album/" + topResultId[0].id;
    else window.location.href = "/search/" + keyword[0].id + "/artist/" + topResultId[1].id;
}
